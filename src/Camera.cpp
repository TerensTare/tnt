...
void tnt::HorizontalCamera::Move(float x, float)
{
    bounds.x = bounds.x + x;
}
...
void tnt::HorizontalCamera::MoveTo(float x, float)
{
    bounds.x = x;
}
...
void tnt::FullTrackingCamera::MoveX(float x)
{
    bounds.x = bounds.x + x;
}

void tnt::FullTrackingCamera::MoveY(float y)
{
    bounds.y = bounds.y + y;
}
