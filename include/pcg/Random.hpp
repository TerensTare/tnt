...
namespace tnt
{
    ...
    /// @return float
    TNT_API inline float randomFloat(float min_, float max_)
    {
    ...
    /// @return int
    TNT_API inline int randomInt(int min_, int max_)
    {
        static std::random_device device;
    ...
    TNT_API inline auto halton1(I const base, I index) noexcept
    {
    ...
    template <std::integral I>
    TNT_API inline Vector halton2(I const baseX, I const baseY, I index) noexcept
    {
