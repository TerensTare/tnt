...
// TODO: lanes
// TODO: if this implementation is succesful, move all function definitions to
// the cpp file.
...
namespace tnt
{
    ...
    class ActionList final
    {
      public:
        ...
        {
            members.push(std::make_shared<Action>(action));
        }
        ...
        decltype(auto) front() noexcept(noexcept(members.front()))
        {
