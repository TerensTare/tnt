...
namespace tnt
{
    ...
    {
      public:
        Action() : blocking{false}, done{false}, index{-1}, list{nullptr} {}
    ...
    class ActionList
    {
      public:
        ...
        {
            for (pos; pos < items.size(); ++pos) ++items[pos]->index;
        }
    ...
    {
      public:
        explicit DelayAction(float duration) : elapsed{.0f}, total{duration} {}
