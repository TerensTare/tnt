#ifndef SCOPE_UTILS_HPP
#define SCOPE_UTILS_HPP
...
// call this.
template <typename Function, typename = typename std::enable_if<std::is_function<Function>::value>::value>
auto on_exit(Function &&f) { return finally<std::decay_t<Function>>{std::forward<Function>(f)}; }
} // namespace tnt

#endif //!SCOPE_UTILS_HPP