...
namespace tnt::detail
{
    ...
    inline medium_texture_atlas_cache def_texture_atlas_cache{};
} // namespace tnt::detail
...
namespace tnt
{
    ...
    inline medium_texture_atlas_cache *default_texture_atlas_cache() noexcept { return &detail::def_texture_atlas_cache; }
} // namespace tnt
